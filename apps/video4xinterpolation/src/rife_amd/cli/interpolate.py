...
from rife_amd.runtime.video_io import read_frames
...
def main(argv: list[str] | None = None) -> None:
    ...
    from rife_amd.runtime.memory import create_memory_planner
    ...
    with RifeInferenceEngine(cfg, on_progress=on_progress) as engine:
        result = engine.interpolate_video(args.input, args.output, fps=args.fps)
