...
from rife_amd.runtime.memory.types import MemoryMode, MemoryProfile, parse_memory_mode
...
def create_memory_planner(platform: str | None = None) -> MemoryPlanner:
    ...
    if plat == HostPlatform.WINDOWS:
        from rife_amd.runtime.memory.windows import WindowsMemoryPlanner

        return WindowsMemoryPlanner()
    from rife_amd.runtime.memory.posix import PosixMemoryPlanner
